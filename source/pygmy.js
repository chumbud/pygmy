...
const areaExpand = function() {
  expand_switch.onmousedown = function(e) {
...
expand_switch.addEventListener('click', areaExpand())
...
const openEmojiPanel = function() {
  mood_board_switch.onmousedown = function(e) {
    mood_board.classList.toggle("open")
  }
}

mood_board_switch.addEventListener('click', openEmojiPanel())
